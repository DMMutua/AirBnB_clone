...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        """Initialization method of objects of the BaseModel Class.
            args:
                ...
                **kwargs: key/value pairs for attribute setting
                            on instantiation of class objects
        """
    ...
    def save(self):
        ...
        of an object to the current date-time"""
    ...
    def to_dict(self, save_fs=None):
        ...
        instance of the BaseClass.
            the Attributes `created_at` and `updated_at`
            are returned as type `str`and in ISO format.
        """
        ...
        if "created_at" in new_dict:
            if isinstance(new_dict["created_at"], datetime):
                new_dict["created_at"] = new_dict["created_at"].strftime(
                        "%Y-%m-%dT%H:%M:%S.%f")
                # use strftime() to format the time above;
